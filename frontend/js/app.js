...
function showCardPreview(card) {
    ...
    canvas.innerHTML = `
        ...
        <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
            ...
            <div class="id-name" style="font-size: 1.4rem; color: #fff; font-weight: 700; text-align: center; line-height: 1.2;">${card.first_name.toUpperCase()} ${card.last_name.toUpperCase()}</div>
...
async function downloadPDF() {
    ...
    try {
        ...
        const notify = alert("Generating high-quality PDF... Please wait a moment.");
        ...
        window.location.href = `${API_BASE}/idcards/proxy-download/${key}`;
